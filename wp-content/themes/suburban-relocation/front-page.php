...
<main id="main-content" class="srs-front-page">
	<section class="srs-home-hero" id="top" style="--srs-hero-image:url('<?php echo esc_url( srs_get_home_option( 'hero_image' ) ); ?>')">
		...
		<div class="srs-container srs-home-hero-grid">
			<div class="srs-hero-copy">
				...
				<div class="srs-hero-actions"><a class="srs-button" href="#quote"><?php echo esc_html( srs_get_home_option( 'hero_button' ) ); ?> <?php echo srs_icon( 'arrow-right' ); ?></a><a class="srs-phone-link" href="tel:<?php echo esc_attr( srs_phone_href( $phone ) ); ?>"><span class="srs-phone-icon"><?php echo srs_icon( 'phone' ); ?></span><span><small><?php esc_html_e( 'Speak with a moving expert', 'suburban-relocation' ); ?></small><strong><?php echo esc_html( $phone ); ?></strong></span></a></div>
			</div>
	...
	<?php if ( '1' === srs_get_home_option( 'process_enabled' ) ) : ?>
		<section class="srs-section srs-process-section" id="process"><div class="srs-container srs-process-grid"><div class="srs-process-copy"><p class="srs-eyebrow"><?php echo esc_html( srs_get_home_option( 'process_kicker' ) ); ?></p><h2><?php echo esc_html( srs_get_home_option( 'process_title' ) ); ?></h2><p><?php echo esc_html( srs_get_home_option( 'process_text' ) ); ?></p><a class="srs-outline-button" href="#quote"><?php esc_html_e( 'Start planning', 'suburban-relocation' ); ?> <?php echo srs_icon( 'arrow-right' ); ?></a></div><ol class="srs-steps"><?php for ( $i = 1; $i <= 3; $i++ ) : ?><li><span><?php echo esc_html( $i ); ?></span><div><h3><?php echo esc_html( srs_get_home_option( 'step_' . $i . '_title' ) ); ?></h3><p><?php echo esc_html( srs_get_home_option( 'step_' . $i . '_text' ) ); ?></p></div></li><?php endfor; ?></ol></div></section>
	<?php endif; ?>

	<?php if ( '1' === srs_get_home_option( 'locations_enabled' ) ) : ?>
		<section class="srs-section srs-locations-section" id="locations"><div class="srs-container srs-home-location-grid"><div class="srs-map-panel" aria-hidden="true"><span class="srs-map-orbit one"></span><span class="srs-map-orbit two"></span><span class="srs-map-dot one"><i></i> Maryland</span><span class="srs-map-dot two"><i></i> Washington, DC</span><span class="srs-map-dot three"><i></i> Virginia</span><span class="srs-map-center"><?php echo srs_icon( 'truck' ); ?></span></div><div class="srs-location-copy"><p class="srs-eyebrow dark"><?php echo esc_html( srs_get_home_option( 'locations_kicker' ) ); ?></p><h2><?php echo esc_html( srs_get_home_option( 'locations_title' ) ); ?></h2><p><?php echo esc_html( srs_get_home_option( 'locations_text' ) ); ?></p><ul><li><?php echo srs_icon( 'check' ); ?> Maryland</li><li><?php echo srs_icon( 'check' ); ?> Washington, DC</li><li><?php echo srs_icon( 'check' ); ?> Northern Virginia</li><li><?php echo srs_icon( 'check' ); ?> Interstate moves</li></ul><a class="srs-text-link" href="#quote"><?php esc_html_e( 'Check your route', 'suburban-relocation' ); ?> <?php echo srs_icon( 'arrow-right' ); ?></a></div></div></section>
	<?php endif; ?>

	<?php if ( '1' === srs_get_home_option( 'reviews_enabled' ) ) : ?>
		<section class="srs-section srs-reviews-section" id="reviews"><div class="srs-container srs-review-layout"><div class="srs-review-intro"><p class="srs-eyebrow"><?php echo esc_html( srs_get_home_option( 'reviews_kicker' ) ); ?></p><h2><?php echo esc_html( srs_get_home_option( 'reviews_title' ) ); ?></h2><div class="srs-rating"><strong><?php echo esc_html( srs_get_home_option( 'reviews_rating' ) ); ?></strong><span>★★★★★<small><?php esc_html_e( 'Customer-first service', 'suburban-relocation' ); ?></small></span></div></div><div class="srs-review-slider" data-review-slider><?php for ( $i = 1; $i <= 3; $i++ ) : ?><article class="srs-review-slide<?php echo 1 === $i ? ' is-active' : ''; ?>" data-review-slide><span class="srs-quote-mark"><?php echo srs_icon( 'sparkles' ); ?></span><blockquote>“<?php echo esc_html( srs_get_home_option( 'review_' . $i . '_quote' ) ); ?>”</blockquote><footer><span><strong><?php echo esc_html( srs_get_home_option( 'review_' . $i . '_name' ) ); ?></strong><small><?php echo esc_html( srs_get_home_option( 'review_' . $i . '_detail' ) ); ?></small></span><span class="srs-review-controls"><button type="button" data-review-prev aria-label="Previous review"><?php echo srs_icon( 'arrow-left' ); ?></button><em data-review-count><?php echo esc_html( $i . ' / 3' ); ?></em><button type="button" data-review-next aria-label="Next review"><?php echo srs_icon( 'arrow-right' ); ?></button></span></footer></article><?php endfor; ?></div></div></section>
	<?php endif; ?>

	<?php if ( '1' === srs_get_home_option( 'faq_enabled' ) ) : ?>
		<section class="srs-section srs-faq-section"><div class="srs-container srs-faq-grid"><div><p class="srs-eyebrow dark"><?php echo esc_html( srs_get_home_option( 'faq_kicker' ) ); ?></p><h2><?php echo esc_html( srs_get_home_option( 'faq_title' ) ); ?></h2><p><?php echo esc_html( srs_get_home_option( 'faq_text' ) ); ?></p><a class="srs-text-link" href="tel:<?php echo esc_attr( srs_phone_href( $phone ) ); ?>"><?php echo esc_html( sprintf( __( 'Call %s', 'suburban-relocation' ), $phone ) ); ?> →</a></div><div class="srs-faq-list"><?php for ( $i = 1; $i <= 3; $i++ ) : ?><details<?php echo 1 === $i ? ' open' : ''; ?>><summary><?php echo esc_html( srs_get_home_option( 'faq_' . $i . '_question' ) ); ?></summary><p><?php echo esc_html( srs_get_home_option( 'faq_' . $i . '_answer' ) ); ?></p></details><?php endfor; ?></div></div></section>
	<?php endif; ?>
