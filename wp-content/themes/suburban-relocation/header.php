...
<header class="srs-site-header">
	<div class="srs-utility-bar">
		<div class="srs-container srs-utility-inner">
			...
			<div><span><?php echo srs_icon( 'clock' ); ?> <?php echo esc_html( srs_get_option( 'hours', 'Mon–Sun, 8am–8pm' ) ); ?></span><a href="tel:<?php echo esc_attr( srs_phone_href() ); ?>"><?php echo srs_icon( 'phone' ); ?> <?php echo esc_html( srs_get_option( 'phone', '800-816-6834' ) ); ?></a></div>
		</div>
	</div>
	<div class="srs-container srs-header-inner">
		...
		<a class="srs-header-cta" href="<?php echo esc_url( home_url( '/#quote' ) ); ?>"><?php esc_html_e( 'Free quote', 'suburban-relocation' ); ?> <?php echo srs_icon( 'arrow-right' ); ?></a>
	</div>
</header>
